...
<div class="grid gap-4 md:grid-cols-2">
    ...
    <div>
        ...
        <input type="number" step="0.1" name="calories_per_100g" id="calories_per_100g" class="input input-bordered w-full"
    ...
    <div>
        ...
        <input type="number" step="0.1" name="protein_per_100g" id="protein_per_100g" class="input input-bordered w-full"
    ...
    <div>
        ...
        <input type="number" step="0.1" name="carbs_per_100g" id="carbs_per_100g" class="input input-bordered w-full"
    ...
    <div>
        ...
        <input type="number" step="0.1" name="fat_per_100g" id="fat_per_100g" class="input input-bordered w-full"
    ...
    <div>
        ...
        <input type="text" name="image_path" id="image_path" class="input input-bordered w-full"
...
<div class="form-control mt-4">
    <label class="label cursor-pointer justify-start gap-3">
        <input type="checkbox" name="is_verified" value="1" class="checkbox"
